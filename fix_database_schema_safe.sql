-- Fix database schema - Add missing columns and tables (Safe version)
...
-- Create missing deposit_requests table (alias for deposits)
...
-- Create missing withdrawal_requests table (alias for withdrawals)
...
-- Create missing audit_log table (if needed for audit trail)
...
-- Output confirmation
SELECT 'Database schema fixes completed safely!' as status;

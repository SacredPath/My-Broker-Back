...
-- DATA: auth.users
-- Records: 0
-- Note: Auth users may need to be created via Supabase Auth API
INSERT INTO auth.users (id, email, email_confirmed_at, created_at, updated_at, last_sign_in_at) VALUES ('undefined', '', NULL, 'undefined', 'undefined', NULL);

-- Basic Triggers Check - Simple Column Discovery
-- Execute this in Supabase SQL Editor
-- This script first discovers available columns then checks triggers
...
-- Then check if any triggers exist with basic columns
SELECT 
...
-- Output summary
SELECT 
    'Basic Triggers Check Completed' as status,
    NOW() as check_time,

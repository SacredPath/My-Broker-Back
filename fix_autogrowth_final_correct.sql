-- Final correct autogrowth function that works with generated total column
...
BEGIN
    ...
    LOOP
        ...
        -- Update wallet balance if exists (FIXED: only update available, total is generated)
        UPDATE wallet_balances 
        SET 
            available = new_balance - user_balance.locked_amount,  -- Add growth to available funds
            updated_at = NOW()
        WHERE user_id = user_balance.user_id 
            AND currency = user_balance.currency;

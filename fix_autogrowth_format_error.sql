-- Fix the format error in autogrowth function
...
BEGIN
    ...
    LOOP
        ...
        -- Determine tier based on total balance (FIXED: only select needed columns)
        ...
        -- Create notification for user (FIXED format string)

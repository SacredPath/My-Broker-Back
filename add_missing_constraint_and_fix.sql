-- Add missing unique constraint to user_balances table
ALTER TABLE user_balances 
ADD CONSTRAINT user_balances_user_id_currency_key 
UNIQUE (user_id, currency);

-- Now fix the process function with proper ON CONFLICT usage

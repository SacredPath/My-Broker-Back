-- Final fix for calculate_daily_autogrowth function
-- Includes updated_at field in notifications insert
...
BEGIN
    ...
    LOOP
        ...
        -- Create notification for user (FIXED: include updated_at field)

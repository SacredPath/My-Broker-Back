-- Check specifically for triggers on the notifications table
SELECT 
    ...
    CASE 
        ...
        WHEN (t.tgtype & 8) != 0 AND (t.tgtype & 16) != 0 THEN 'UPDATE/DELETE'
        WHEN (t.tgtype & 1) != 0 AND (t.tgtype & 8) != 0 AND (t.tgtype & 16) != 0 THEN 'INSERT/UPDATE/DELETE'
        ELSE 'UNKNOWN'
